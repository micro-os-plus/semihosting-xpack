...
- name the post like: **µOS++ semihosting v6.0.0 released**
...
- `npm dist-tag add @micro-os-plus/semihosting@6.0.0 latest`
- `npm dist-tag ls @micro-os-plus/semihosting`
...
- paste the release name like **µOS++ semihosting v6.0.0 released**
