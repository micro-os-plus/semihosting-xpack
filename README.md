...
- `MICRO_OS_PLUS_SEMIHOSTING_STARTUP_ENABLED`
- `MICRO_OS_PLUS_SEMIHOSTING_STARTUP_CMDLINE_BUFFER_ARRAY_SIZE_INTEGER` (80)
- `MICRO_OS_PLUS_SEMIHOSTING_STARTUP_ARGV_BUFFER_ARRAY_SIZE_INTEGER` (10)
