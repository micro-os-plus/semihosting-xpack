...
- name the post like: **µOS++ semihosting v3.0.2 released**
...
- `npm dist-tag add @micro-os-plus/semihosting@3.0.2 latest`
- `npm dist-tag ls @@micro-os-plus/semihosting`
...
- paste the release name like **µOS++ semihosting v3.0.2 released**
